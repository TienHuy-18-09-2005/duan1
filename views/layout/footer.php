                        ...
                        <div class="widget-item">
                            <div class="widget-title">
                                <div class="widget-logo">
                                    <a href="index.html">
                                        <img src="assets/img/dog.png" width="40px" alt="brand logo">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> Tòa nhà FPT Polytechnic., Cổng số 2, 13 P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội, Việt Nam</li>
                                        <li><i class="pe-7s-mail"></i> <a href="#">huyyntph52807@gmail.com</a></li>
                                        <li><i class="pe-7s-call"></i> <a href="#">0333801610</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2024 <b>Xưởng thú cưng</b> Made with <i class="fa fa-heart text-danger"></i> by <a href="#"><b>HuyNT</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
