            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="checkoutaccordion" id="checkOutAccordion">
                        <div class="card">
                            <h6>Thêm mã giảm giá? <span data-bs-toggle="collapse"
                        ...
                        <div class="billing-form-wrap">
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="email" id="email_nguoi_nhan" name="email_nguoi_nhan"
                                        value="<?= $user['email'] ?>" placeholder="Email người nhận" required />
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($chiTietGioiHang as $key => $sanPham):
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="">
                                                        <?= $sanPham['ten_san_pham'] ?> <strong> × <?= $sanPham['so_luong'] ?>
                                                    </a>
                                                </td>
                                                <td>
                                                    <?php
                                ...
                                <div class="single-payment-method show">
                                    <div class="payment-method-name">
                                        <div class="custom-control custom-radio">
                                            ...
                                            name="phuong_thuc_thanh_toan_id" class="custom-control-input" checked />
