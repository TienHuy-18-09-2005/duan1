...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-11">
          <h1>Sửa thông tin thú cưng: <?= $sanPham['ten_san_pham'] ?></h1>
        </div>
        <div class="col-sm-1 ">
      ...
      <div class="col-md-4">
        ...
        <div class="card card-info">
          ...
          <div class="card-body p-0">
            <form action="<?= BASE_URL_ADMIN . '?act=sua-album-anh-pham' ?>" method="post"
...
var faqs_row = <?= count($listAnhSanPham); ?>;
  ...
  function addfaqs() {
    ...
    html += '<td><img src="https://i.imgur.com/puGSsnW.jpg" style="width: 50px; height: 50px;" alt=""></td>';
